    ...
    public partial class SeedInitialData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lek przeciwbólowy", "Apap", "Tabletki" },
                    { 2, "Lek przeciwzapalny", "Ibuprom", "Kapsułki" },
                    { 3, "Wspiera odporność", "Rutinoscorbin", "Tabletki" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Piotr", "Zielinski" },
                    { 2, new DateTime(1985, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Maria", "Wojcik" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, new DateTime(2023, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2 },
                    { 3, new DateTime(2023, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "2 razy dziennie po posiłku", 2 },
                    { 2, 1, "1 raz dziennie wieczorem", 1 },
                    { 3, 2, "3 razy dziennie", 3 },
                    { 1, 3, "1 raz dziennie rano", 1 }
                });
